    ...
    <div className="platform-section__inner">
      ...
      <div className="platform-text">
        ...
        <p>
          ...
          Create a profile with embedded videos and social links – no uploads
          required. Your content stays on your terms. Connect with clients,
          receive booking requests, and share your profile via QR code – 
          anywhere, anytime.
        </p>
        <Link to="/gallery">
